...
def main():
    ...
    if submit_button and user_text:
        ...
        with tab3:
            ...
            fig_phase = create_chaotic_phase_plot(binary_output, dt=0.01, a=0.2, b=0.2, c=5.7, x0=0.1, y0=0.0, z0=0.0)
